...
class NoopAction extends IdlerAction {
...
class SetTagAction extends IdlerAction {
...
class UnsetTagAction extends IdlerAction {
    constructor(who, tag) {
        super(who, 'unsetTag');
        this.tags = [
            {
...
class StopAction extends IdlerAction {
    constructor(who) {
        super(who, 'stop');
...
class StartAction extends IdlerAction {
    constructor(who) {
        super(who, 'start');
        this.changesState = true;
    }
...
class RestoreRdsSg extends IdlerAction {
    constructor(who) {
